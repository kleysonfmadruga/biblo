    ...
    <body>
        ...
        <div class="flex flex-row px-24 items-center h-screen w-screen bg-gradient-to-br from-blue-400 to-indigo-800 rotate-12">
            ...
            <aside class="w-4/12 mx-4">
                @auth
                    <form action="{{ route('index') }}" method="get" class="rounded-lg flex flex-col px-8 py-16 h-80 items-center justify-around shadow-lg bg-white">
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-sm">Hmmmm... Você já está logado. &#x1F914;</p>
                            <p class="text-sm mt-1">Então basta é só clicar no botão. &#x1F609;</p>
                        </div>
                        <input type="submit" value="Entrar" class="w-64 h-12 bg-blue-800 text-white font-bold rounded-md focus:outline-none hover:bg-blue-900 cursor-pointer" />
                    </form>
                @endauth
                @guest
